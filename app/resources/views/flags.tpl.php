        ...
        <div class="panel panel-primary fresh-color wow bounceInUp" data-wow-duration=".5s">
            <div class="panel-heading">
                <div class="pull-right">
                    <a class="btn btn-default btn-xs" href="{{url()->to('/flag/create')}}">
                    ...
                    <table class="table table-striped table-condensed table-responsive table-dynamic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="" class="text-right"><a class="btn btn-info btn-xs" href="{{url()->to("/flag/$flag->id")}}" data-toggle="tooltip" title="Edytuj"><span class="glyphicon glyphicon-edit"></span></a>
