		...
		<div class="panel panel-primary fresh-color wow bounceInUp" data-wow-duration=".5s">
			<div class="panel-heading">
				...
				<div class="pull-right">
					<a class="btn btn-default btn-xs" href="{{ $urlBuilder->to('/user/create') }}">
						...
						<tbody>
							...
							<tr>
								...
								<td data-label="" class="text-right">
									...
									{% endif %}
									<a class="btn btn-warning btn-xs" href="{{ $urlBuilder->to('/user/'.$user->id.'/changepassword') }}" data-toggle="tooltip" title="Zmień hasło"><span class="fa fa-key"></span></a>
									<a class="btn btn-danger btn-xs" href="{{ $urlBuilder->to('/user/'.$user->id) }}" data-toggle="tooltip" title="Edytuj"><span class="glyphicon glyphicon-edit"></span></a>
								</td>
